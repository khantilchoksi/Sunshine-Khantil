...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            if (buffer.length() == 0) {
                ...
                setLocationStaus(getContext(),LOCATION_STATUS_SERVER_DOWN);
                return;
            }
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                //delete old data so that we don't build up an endless history
            ...
            setLocationStaus(getContext(),LOCATION_STATUS_OK);
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCursor = getContext().getContentResolver().query(
                ...
                new String[]{WeatherContract.LocationEntry._ID},        //projection
        ...
        if(displayNotifications){
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    //build your notification here. 4Steps process
                    ...
                    //Step 2.Create an explicit intent for what the notification should open.
                    Intent resultIntent = new Intent(context, MainActivity.class);

                    //Step 3. The stack builder object will contain an artificial back stack for the started Activity.
                    // This ensures that navigating backward from the Activity leads out of
                    // your application to the Home screen.
                    TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);

/*              //This is not required here right now, but might require in near future.
                ...
                stackBuilder.addParentStack(MainActivity.class);*/
                    ...
                    //Step 4. Tell the NotificationManager to show the notification.
    ...
    private static void setLocationStaus(Context c, @LocationStatus int locationStatus){
